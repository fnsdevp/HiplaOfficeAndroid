...
import com.hipla.smartoffice_new.databinding.FragmentFixedMeetingBinding;
                ...
                case "getTimeSlots":
                    ...
                    if (response.optString("message").equalsIgnoreCase("Sorry This user doesn't exist.")) {
                        ...
                        if (timingResponse.optJSONArray("meetings") != null) {
                            ...
                            if (meetingTimeSlotList == null) {
                                meetingTimeSlotList = new ArrayList<>();
                            }
                        }

                        if (timingResponse.getString("status").equalsIgnoreCase("Y"))
                            mTimeAdapter.notifyDataChange(meetingTimeSlotList, timingResponse.optString("date"),
