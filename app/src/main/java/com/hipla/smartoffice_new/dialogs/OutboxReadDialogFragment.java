...
import com.hipla.smartoffice_new.model.OutboxMessages;
 ...
 */
public class OutboxReadDialogFragment extends DialogFragment implements StringRequestListener {

    private OnDialogEvent mListener;
    private ProgressDialog mDialog;
    private OutboxMessages mData;
    private View binding;
    private ImageView ivClose;
    private TextView tvName, tvEmail, tvPhone, tvTitle, tvMessage, btnClose;

    public OutboxReadDialogFragment() {
    ...
    public void setData(OutboxMessages mData){
        this.mData = mData;
    }
    ...
    private void initView(View binding) {
        ...
        tvName.setText(String.format(getString(R.string.name_format), mData.getTo().getName()));
        tvEmail.setText(String.format(getString(R.string.email_format), mData.getTo().getEmail()));
        tvPhone.setText(String.format(getString(R.string.phone_format), mData.getTo().getPhone()));
    ...
    public void updateMessage() {
        try {
            ...
            if (userData != null) {
                ...
                new PostStringRequest(getActivity(), requestParameter, OutboxReadDialogFragment.this, "updateMessages",
