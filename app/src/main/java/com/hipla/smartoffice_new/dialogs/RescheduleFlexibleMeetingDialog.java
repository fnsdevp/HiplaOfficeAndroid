...
import com.hipla.smartoffice_new.adapter.FlexibleTimeSlotAdapter;
import com.hipla.smartoffice_new.adapter.FlexibleWeekListAdapter;
import com.hipla.smartoffice_new.databinding.DialogFragmentFlexibleMeetingBinding;
 ...
 */
public class RescheduleFlexibleMeetingDialog extends DialogFragment implements SelectContactFragment.OnContactSelected,
    ...
    private DialogFragmentFlexibleMeetingBinding binding;
    ...
    public RescheduleFlexibleMeetingDialog() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_fragment_flexible_meeting, container, false);
        binding.setFragment(RescheduleFlexibleMeetingDialog.this);
    ...
    private void initView() {
        ...
        mAdapter.setOnDateClickListener(RescheduleFlexibleMeetingDialog.this);
        ...
        /*binding.ivAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MarshmallowPermissionHelper.getReadContactPermission(RescheduleFlexibleMeetingDialog.this, getActivity(),
                        READ_CONTACT_PERMISSION)) {
                    SelectContactFragment mDialog = new SelectContactFragment();
                    mDialog.setOnContactSelected(RescheduleFlexibleMeetingDialog.this);
        ...
        mTimeAdapter.setOnTimeSlotClickListener(RescheduleFlexibleMeetingDialog.this);
    ...
    private void showDatePicker() {
        ...
        DatePickerDialog pickerDialog = new DatePickerDialog(getActivity(), RescheduleFlexibleMeetingDialog.this,
    ...
    public void getAvailableTimes(String startDate, String endDate) {
        ...
        if (selectedContact != null && userData.getUsertype().equalsIgnoreCase("Guest")) {
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleFlexibleMeetingDialog.this, "getTimeSlots",
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleFlexibleMeetingDialog.this, "getEmployeeTimeSlots",
    ...
    public void getUpcomingTime(String date) {
        ...
        if (selectedContact != null) {
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleFlexibleMeetingDialog.this, "getUpcomingMeeting",
    ...
    public void getAvailableRooms(String date) {
        ...
        if (selectedContact != null) {
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleFlexibleMeetingDialog.this, "getAvailableRooms",
    ...
    public void submitCreateMeeting() {
        ...
        if (selectedContact != null && !selectedStartDates.isEmpty() && !selectedEndDates.isEmpty()
            ...
            if (userData.getUsertype().equalsIgnoreCase("Guest")) {
                ...
                getAvailableRooms(selectedStartDates);
            }
    ...
    private void showRoomDialogs(List<RoomData> roomDataList) {
        Dialogs.dialogShowRooms(getActivity(),roomDataList, new Dialogs.OnOptionSelect() {
            ...
            public void setRowClick(RoomData roomData) {
                ...
                createFlexibleMeeting(roomData.getPlace_unique_id());
            }
        });
    }
    ...
    public void createFlexibleMeeting() {
        try {
            ...
            if (selectedContact != null) {
                ...
                new PostStringRequest(getActivity(), requestParameter, RescheduleFlexibleMeetingDialog.this, "bookMeeting",
