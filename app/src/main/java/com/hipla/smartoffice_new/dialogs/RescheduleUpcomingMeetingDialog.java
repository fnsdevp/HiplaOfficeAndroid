...
import com.hipla.smartoffice_new.adapter.TimeSlotAdapter;
import com.hipla.smartoffice_new.adapter.WeekListAdapter;
import com.hipla.smartoffice_new.databinding.DialogRescheduleFixedMeetingBinding;
 ...
 */
public class RescheduleUpcomingMeetingDialog extends android.support.v4.app.DialogFragment implements SelectContactFragment.OnContactSelected, WeekListAdapter.OnDateClickListener, StringRequestListener, TimeSlotAdapter.OnTimeSlotClickListener, DatePickerDialog.OnDateSetListener {

    private static final int READ_CONTACT_PERMISSION = 101;
    private DialogRescheduleFixedMeetingBinding binding;
    ...
    public RescheduleUpcomingMeetingDialog() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_reschedule_fixed_meeting, container, false);
        binding.setFragment(RescheduleUpcomingMeetingDialog.this);
    ...
    private void initView() {
        ...
        mAdapter.setOnDateClickListener(RescheduleUpcomingMeetingDialog.this);
        ...
        mTimeAdapter.setOnTimeSlotClickListener(RescheduleUpcomingMeetingDialog.this);
    ...
    private void showDatePicker() {
        ...
        DatePickerDialog pickerDialog = new DatePickerDialog(getActivity(), RescheduleUpcomingMeetingDialog.this,
    ...
    public void getAvailableTimes(String date) {
        ...
        if (selectedContact != null && userData.getUsertype().equalsIgnoreCase("Guest")) {
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleUpcomingMeetingDialog.this, "getTimeSlots",
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleUpcomingMeetingDialog.this, "getEmployeeTimeSlots",
    ...
    public void getUpcomingTime(String date) {
        ...
        if (selectedContact != null) {
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleUpcomingMeetingDialog.this, "getUpcomingMeeting",
    ...
    public void getAvailableRooms(String date) {
        ...
        if (selectedContact != null) {
            ...
            new PostStringRequest(getActivity(), requestParameter, RescheduleUpcomingMeetingDialog.this, "getAvailableRooms",
            ...
            switch (type) {
                ...
                case "getAvailableRooms":
                    ...
                    if (responseRooms.optString("status").equalsIgnoreCase("success")) {
                        ...
                        List<RoomData> roomDataList = Arrays.asList(meetingTimeSlot);

                        if (roomDataList != null)
                            showRoomDialogs(roomDataList);
                    }
                ...
                case "bookMeeting":
                    ...
                    if (bookMeeting.optString("message").equalsIgnoreCase("your request has been sent")) {
                        ...
                        CONST.cancelMeetingETAJob(getActivity(), CONST.SCHEDULE_ETA_DETECTION_JOB_ID);
                        CONST.cancelEndMeetingJob(getActivity(), CONST.SCHEDULE_END_MEETING_JOB_ID);
                        CONST.cancelStartMeetingJob(getActivity(), CONST.SCHEDULE_START_MEETING_JOB_ID);
                        CONST.cancelExtendMeetingJob(getActivity(), CONST.SCHEDULE_START_MEETING_JOB_ID);

                        CONST.scheduleMeetingFetchJob(getActivity(), 1000, CONST.FETCH_JOB_ID);
    ...
    public void submitCreateMeeting() {
        ...
        if (selectedContact != null && !selectedDates.isEmpty() && selectedStartTimeSlot != null
            ...
            if (userData.getUsertype().equalsIgnoreCase("Guest")) {
                ...
                getAvailableRooms(selectedDates);
            }
    ...
    public void createFixedMeeting() {
        try {
            ...
            if (selectedContact != null) {
                ...
                requestParameter.put("phone", String.format("%s", selectedContact.getPhone()));
                requestParameter.put("duration", String.format("%s", ""+df.format(hours)));
                ...
                new PostStringRequest(getActivity(), requestParameter, RescheduleUpcomingMeetingDialog.this, "bookMeeting",
